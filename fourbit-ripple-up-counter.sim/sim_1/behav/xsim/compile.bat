...
REM
REM Generated by Vivado on Tue Jul 22 23:58:39 +0530 2025
...
echo "xvlog --incr --relax -prj four_bit_ripple_up_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj four_bit_ripple_up_counter_tb_vlog.prj -log xvlog.log
